...
|LED1 |Versal 起動状態表示インタフェース |LED (黄緑色) |
|LED2 |Versal エラー状態表示インタフェース |LED (赤色) |
|LED3 |1Gbps Ethernet リンク状態表示インタフェース |LED (黄緑色) |
|LED4 |FMC モジュール電源供給 状態表示インタフェース |LED (黄緑色) |
|LED5 |I/F ボード主電源供給 状態表示インタフェース |LED (黄緑色) |
