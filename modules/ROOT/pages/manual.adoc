...
|Versal PMC MIO 1 |OBC の Versal Bank 501 に属する MIO を示す。
|Versal LPD MIO |OBC の Versal Bank 502 に属する MIO を示す。
|===
...
RTC と BBRAM は、通常は OBC 内で生成される電圧 (VCCAUX_PMC_SMON) により動作していますが、OBC の主電源が途絶えた場合、CON2 から供給される電圧で維持、または保持されます。
