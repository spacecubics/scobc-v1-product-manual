...
CON12 は、Versal の未使用 MIO 信号を外部に引き出すためのインタフェースです。
接続されているのは LPD MIO 0 から 11 と、IC27 を介した PMC MIO 12 および PMC MIO 37 です。
ただし、一部の LPD MIO はジャンパ設定により FTDI、CAN、FMCモジュール接続用インタフェース(CON11) 側の回路にも接続できます。
